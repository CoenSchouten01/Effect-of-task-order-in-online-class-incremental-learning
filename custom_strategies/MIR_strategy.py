...
from custom_strategies.MIR_plugin import MIRPlugin
from avalanche.training.templates import SupervisedTemplate

class MIR(SupervisedTemplate):
    """ Slightly modified MIR strategy from the Avalanche library
    Uses the modified MIR plugin (for fixing batch normalization error)
    All credits go to avalanche library.
    Maximally Interfered Replay Strategy
    See MIR plugin for details.
    """
